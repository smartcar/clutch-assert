...
assert.throws = function(fn, err, msg) {
  ...
  if (typeof fn !== 'function') { // eslint-disable-next-line max-len
    throw new TypeError('assert.throws must be called with a function, or Promise');
  }
...
assert.notThrows = function(fn, msg) {
  ...
  if (typeof fn !== 'function') { // eslint-disable-next-line max-len
    throw new TypeError('assert.notThrows must be called with a function, or Promise');
  }
